 ...
 * Optimization: Using a hash map for O(1) lookup complexity instead of if-else chains.
 */
...
function sendMessage() {
    ...
    // Fake response
    setTimeout(() => {
        // Performance optimization: Use a hash map for character responses to ensure O(1) lookup time.
