 ...
 * Performance optimization: O(1) hash map lookup instead of O(N) if-else chain.
 */
const characterResponses = {
    ...
    'Chihiro': "I'm working hard at the bathhouse. Have you seen my parents?",
    'Haku': "Remember who you are. The spirits here can be tricky."
};
 ...
 * Performance optimization: O(1) DOM update using appendChild and textContent.
...
function appendChatMessage(container, sender, text) {
    ...
    msgPara.appendChild(senderStrong);
