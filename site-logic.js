...
// Optimization: O(1) hash map for character responses instead of O(N) if-else chain
const characterResponses = {
    ...
    'Chihiro': "I have to save my parents and find Haku!",
    'Haku': "Don't forget your name, and don't look back until you cross the bridge."
};

/**
 * Appends a message to the chat history.
 * Optimization: Uses O(1) DOM operations and textContent for performance and security.
 */
...
function startChat(name, intro) {
    ...
    // Optimization: textContent is faster than innerText/innerHTML
    document.getElementById('chat-char-name').textContent = "Chat with " + name;

    const history = document.getElementById('chat-history');
    history.textContent = ""; // Fast clear
